...
class ConvertBetweenBases {
  ...
  private decimalToAnyBase (InputNumber:number , OutputBase:number) : string { 
        let Result:string = "" ;
        let UnitConverted:string ;
        let UnitExtracted:any ;                
        do {
  ...
  private validationsInput (InputNumber:string , InputBase:number , OutputBase:number) : string {
  ...
  public main ( InputNumber:string|number , InputBase:number , OutputBase:number ) : string {
        if (typeof InputNumber === "string"){
                InputNumber = InputNumber.toString().toUpperCase();
        }
        
        let isValid:string = this.validationsInput(InputNumber.toString(),InputBase,OutputBase);
        if ( isValid !== "true" ){
                return isValid ;
        }
